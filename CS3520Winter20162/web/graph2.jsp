<%-- 
    Document   : graph2
    Created on : Mar 4, 2016, 10:26:59 PM
    Author     : Ryan Rigato
--%>
...
<html>
    <head>
        ...
        <title>Pokemon Video Game Sales</title>
        <script src="//d3js.org/d3.v3.min.js"></script>
    </head>
        <c:import url="Header.jsp"/>  
    <body>
       <h2> Number of Pokemon Games Sold by Title (in millions)</h2>
        <script>
        ...
        <div class="explanation">
            ...
            <a href="http://vgsales.wikia.com/wiki/Pok%C3%A9mon">Source: Wikia</a>
